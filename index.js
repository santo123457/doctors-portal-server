...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.pldoz6k.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
  try {
    ...
    app.put("/users/admin/:id", verifyJWT, async (req, res) => {
      ...
      if (user?.role !== "admin") {
        return res.status(301).send({ message: "forbidden access" });
      }
